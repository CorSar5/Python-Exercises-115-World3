...
def lerArquivo(nome):
    ...
    try:
        ...
        for linha in a:
            ...
            print(f'{c} {dado[0]:<10} {dado[1]:<15}{dado[2]:>4} anos')
            c+=1
    finally:
        a.close()


def cadastrar(arq,c,  nome='desconhecido', nome2 = 'desconhecido', idade=0):
    try:
...
def eliminar(arq, nome='desconhecido', nome2 = 'desconhecido', idade = 0):
    try :
        a = open(arq,'at')
    except:
