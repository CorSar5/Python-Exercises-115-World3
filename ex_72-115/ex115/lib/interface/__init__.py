def leiaString(mens):
    while True:
        k = ('merda','caralho','pila','penis','pica','piça','foda-se','fodase','pénis','fodasse','puta','cona','cabrao','vaca', 'foda', '1', '2', '3', '4', '5', '6', '7', '8', '9', '0')
        try:
...
def leiaInt(msg):
    while True:
        try:
            n = int(input(msg))
            if n< 0:
                print('\033[31mERRO: por favor, digite uma idade real\033[m')
                continue
            elif n>115:
                print('\033[31mERRO: por favor, digite uma idade real\033[m')
                continue
